...
After configuring these two components you can specify the connection properties in the [application.properties](src/main/resources/application.properties) config file.

> the process project can be imported into Business Central from [this repository](https://github.com/rafaeltuelho/PHM-integration-service)
...
Access the OpenAPI docs: http://localhost:8181/webjars/swagger-ui/index.html?url=/camel/api-doc
