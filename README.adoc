...
. Change the directory to the folder that contains the extracted booster application (for example, `my_openshift/PHM-integration-service`) :
+
[source,bash,options="nowrap",subs="attributes+"]
----
$ cd my_openshift/PHM-integration-service
----
